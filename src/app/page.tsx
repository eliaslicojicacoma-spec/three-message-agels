        ...
        >
          ...
          <div className="mx-auto flex min-h-[92vh] w-full max-w-7xl items-end px-4 pb-12 pt-20 sm:px-6 md:pb-16 lg:px-8">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-6 text-5xl font-semibold leading-[0.9] tracking-[-0.06em] text-white md:text-7xl">
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                <Link
                  href="/studies"
                  className="inline-flex min-h-[52px] items-center justify-center bg-[#c9aa72] px-8 text-sm font-semibold text-black shadow-lg transition hover:opacity-95"
                >
                  Estudos Bíblicos
                </Link>
                ...
                <Link
                  href="/blog"
                  className="inline-flex min-h-[52px] items-center justify-center border border-white/40 bg-white/5 px-8 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/10"
                >
                  Explorar Artigos
                </Link>
              </div>
